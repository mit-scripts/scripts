...
Requires: accountadm, execsys, kmod-openafs >= 1.4.8-1.1.2.6.27.9_73.fc9.scripts, scripts-krb5-libs, scripts-httpd, scripts-mod_ssl, openafs, scripts-openafs-client, scripts-openafs-authlibs, scripts-openafs-devel, scripts-openafs-krb5, openafs-debuginfo, openafs-docs, scripts-openssh-server, sql-signup, tokensys, whoisd, logview, nss-ldapd
