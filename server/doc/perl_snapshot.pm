...
Algorithm::Dependency::Item 1.102

Algorithm::Dependency::Ordered 1.102

Algorithm::Dependency::Source 1.102

Algorithm::Dependency::Source::File 1.102

Algorithm::Dependency::Source::HoA 1.102
...
Apache::Session::Lock::Sybase 1.00
...
Apache::Session::Store::File 1.02

Apache::Session::Store::Informix 1.01
...
Apache::Session::Store::Sybase 1.01
...
Apache::TestConfig undef

Apache::TestConfigC undef

Apache::TestConfigPHP undef

Apache::TestConfigParrot undef

Apache::TestHandler undef

Apache::TestHarness undef

Apache::TestHarnessPHP undef
...
CGI::Simple::Standard undef

CGI::Simple::Util 0.03

CGI::Untaint 1.26

CGI::Untaint::date 1.00
...
Class::DBI::Loader::Pg 0.30

Class::DBI::Loader::Relationship 1.3

Class::DBI::Loader::SQLite 0.30
...
DBIx::DBSchema::ColGroup::Index undef
...
DBIx::DBSchema::DBD::Pg 0.10

DBIx::DBSchema::DBD::SQLite 0.01
...
DBIx::SearchBuilder::Union undef
...
Date::Calc::Object 5.4

Date::Calendar 5.4

Date::Calendar::Profiles 5.4

Date::Calendar::Year 5.4
...
Email::FolderType::MH undef

Email::FolderType::Maildir undef
...
Glib::Object::Subclass 0.03

Glib::ParseXSDoc 1.002
...
Locale::Maketext::Extract::Run 0.01
...
Locale::Maketext::Lexicon::Auto 0.03

Locale::Maketext::Lexicon::Gettext 0.15

Locale::Maketext::Lexicon::Msgcat 0.03
...
MIME::Decoder::Base64 5.420

MIME::Decoder::BinHex 5.420

MIME::Decoder::Binary 5.420

MIME::Decoder::Gzip64 5.420

MIME::Decoder::NBit 5.420

MIME::Decoder::QuotedPrint 5.420

MIME::Decoder::UU 5.420

MIME::Entity 5.420

MIME::Field::ConTraEnc 5.420

MIME::Field::ContDisp 5.420

MIME::Field::ContType 5.420

MIME::Field::ParamVal 5.420
...
Mail::Field::AddrList 1.74

Mail::Field::Date 1.74
...
Mail::SpamAssassin::Bayes::CombineChi undef

Mail::SpamAssassin::Bayes::CombineNaiveBayes undef
...
Mail::SpamAssassin::EvalTests undef
...
Mail::SpamAssassin::MailingList undef

Mail::SpamAssassin::Message undef

Mail::SpamAssassin::Message::Metadata undef

Mail::SpamAssassin::Message::Metadata::Received undef
...
Mail::SpamAssassin::Plugin::DomainKeys undef
...
ModPerl::RegistryLoader undef

ModPerl::RegistryPrefork 0.01

ModPerl::StructureMap undef

ModPerl::TestReport undef

ModPerl::TestRun undef
...
Net::Amazon::Attribute::ReviewSet undef

Net::Amazon::Property undef
...
Net::Amazon::Request::Similar undef

Net::Amazon::Request::TextStream undef

Net::Amazon::Request::UPC undef

Net::Amazon::Request::Wishlist undef

Net::Amazon::Response undef
...
Net::Amazon::Response::Similar undef

Net::Amazon::Response::TextStream undef

Net::Amazon::Response::UPC undef

Net::Amazon::Response::Wishlist undef

Net::Amazon::Result::Seller undef
...
Net::DNS::Nameserver 590

Net::DNS::Packet 605

Net::DNS::Question 610
...
Net::DNS::RR::AFSDB 388

Net::DNS::RR::CERT 388

Net::DNS::RR::CNAME 501

Net::DNS::RR::DNAME 388

Net::DNS::RR::EID 388

Net::DNS::RR::HINFO 388
...
Net::DNS::RR::MINFO 388

Net::DNS::RR::MR 388

Net::DNS::RR::MX 564

Net::DNS::RR::NAPTR 583

Net::DNS::RR::NIMLOC 388
...
Net::DNS::RR::Unknown 388

Net::DNS::RR::X25 388

Net::DNS::Resolver 513

Net::DNS::Resolver::Base 610

Net::DNS::Resolver::Recurse 591

Net::DNS::Resolver::UNIX 482
...
PDL::Demos::Cartography_demo undef

PDL::Demos::General undef

PDL::Demos::PGPLOT_OO_demo undef

PDL::Demos::PGPLOT_demo undef

PDL::Demos::TkTriD_demo undef
...
PDL::Doc::Perldl undef

PDL::Exporter undef

PDL::Filter::LinPred undef

PDL::Filter::Linear undef

PDL::Fit::LM undef

PDL::Fit::Linfit undef

PDL::Fit::Polynomial undef

PDL::Func undef

PDL::Gaussian undef

PDL::Graphics2D undef

PDL::Graphics::LUT undef

PDL::Graphics::Limits 0.01

PDL::Graphics::PGPLOT undef

PDL::Graphics::PGPLOT::Window undef

PDL::Graphics::PGPLOTOptions undef

PDL::Graphics::State undef
...
PDL::Opt::Simplex undef

PDL::Options 0.92

PDL::PP 2.2

PDL::PP::PdlParObj undef

PDL::PP::Signature undef
...
SQL::Dialects::ANSI undef

SQL::Dialects::AnyData undef

SQL::Dialects::CSV undef
...
SQL::Statement::Functions 0.1

SQL::Statement::GetInfo undef

SQL::Statement::RAM undef

SQL::Statement::Util undef
...
Spreadsheet::WriteExcel::Big 2.01
...
Spreadsheet::WriteExcel::OLEwriter 2.15
...
XML::Grove::AsCanonXML undef

XML::Grove::AsString undef

XML::Grove::Builder undef

XML::Grove::Factory undef

XML::Grove::IDs undef

XML::Grove::Path undef

XML::Grove::PerlSAX undef

XML::Grove::Sub undef

XML::Grove::Subst undef

XML::Grove::XPointer undef
